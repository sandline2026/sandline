...
const INSTAGRAM_LOOKS: LookItem[] = [
  ...
  {
    id: "look-2",
    image: "/images/products/maldives-corduroy-multi-purpose-coord-set-1.jpg",
    location: "Bali, Indonesia",
    caption: "Effortless tropical afternoons in fine ribbed corduroy co-ords 🌴☕",
    productName: "Maldives Corduroy Multi-Purpose Co-ord Set",
    productSlug: "maldives-corduroy-multi-purpose-coord-set",
    priceUsd: 120,
    collection: "Honeymoon & Travel Edits",
  },
  {
    id: "look-3",
    image: "/images/products/positano-buckled-linen-vest-trouser-set-1.jpg",
    location: "Positano, Italy",
    caption: "Mediterranean cliffside afternoons in buckled linen vest tailoring ☀️",
    productName: "Positano Buckled Linen Vest & Wide-Leg Trouser Set",
    productSlug: "positano-buckled-linen-vest-trouser-set",
    priceUsd: 135,
    collection: "The Resort Evening Edit",
  },
  {
    id: "look-4",
    image: "/images/products/capri-horizon-striped-linen-trouser-set-1.jpg",
    location: "Capri, Italy",
    caption: "Breezy azure pinstripe linen for coastal strolls and sea-view lunch 🌊",
    productName: "Capri Horizon Striped Linen Shirt & Trouser Set",
    productSlug: "capri-horizon-striped-linen-trouser-set",
    priceUsd: 125,
  ...
  },
  {
    ...
    caption: "Island sunsets & tiered sunset maxi flow 🤍✨",
    productName: "Bora Bora Tiered Beach Maxi Dress",
    productSlug: "bora-bora-tiered-beach-maxi-dress",
    priceUsd: 82,
    collection: "The Beach Party Edit",
  },
  {
    id: "look-6",
    image: "/images/products/saint-germain-pinstripe-ribbed-knit-coord-set-1.jpg",
    location: "Parisian Rooftop, France",
    caption: "Twilight aperitifs in ribbed sweetheart knit co-ord tailoring 🍸",
    productName: "Saint-Germain Pinstripe Ribbed Knit Co-ord Set",
    productSlug: "saint-germain-pinstripe-ribbed-knit-coord-set",
    priceUsd: 130,
    collection: "The Resort Evening Edit",
  },
];
